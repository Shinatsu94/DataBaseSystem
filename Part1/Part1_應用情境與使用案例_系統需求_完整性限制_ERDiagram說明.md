...
|---|---|---|
| 應用情境與使用案例 | [題目與應用情境](../專案總攬/專案總覽.md#題目與應用情境) | 說明教室租用系統的使用背景、主要使用者與操作情境。 |
| 系統需求說明 | [系統需求說明](../專案總攬/專案總覽.md#系統需求說明) | 整理學生、教師、管理員與系統自動處理需要支援的功能。 |
| 完整性限制 | [完整性限制](../專案總攬/專案總覽.md#完整性限制) | 說明主鍵、外鍵、唯一限制、Domain 限制與 Trigger 驗證。 |
| ER Diagram 及詳細說明 | [ER Diagram](../專案總攬/專案總覽.md#er-diagram) | 說明 10 個實體之間的關聯基數與參照關係。 |
