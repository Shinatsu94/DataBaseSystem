...
|---:|---:|---|---|---|
| 1 | 2 | A0000001 | pending | 申請資料已收件 |
| 2 | 3 | A0000002 | under_review | 確認設備與座位配置 |
| 3 | 4 | A0000001 | approved | 時段無衝突，核准使用 |
| 4 | 5 | A0000002 | rejected | 設備維護期間無法使用 |
| 5 | 6 | A0000001 | canceled | 依申請取消 |
| 6 | 7 | A0000002 | expired | 日期已逾期並結案 |
| 7 | 8 | A0000001 | completed | 使用完成且設備正常 |
| 8 | 9 | A0000002 | suspended | 設備盤點期間暫停 |
| 9 | 10 | A0000001 | resubmission_required | 要求補充申請資料 |
| 10 | 4 | A0000002 | approved | 第二次複核維持核准 |
